        ...
        <nav class="nav">
            <div class="nav__inner">
                <a href="#" class="nav__logo">
                    <img src="../assets/img/Logo.svg" alt="Позитолк">
                </a>
                                <div class="nav__menu">
        ...
        <div class="profile__body">
            <div class="profile__header">
                ...
                <div class="profile__btns">
                    ...
                    <div class="profile__save-btn">Сохранить изменения</div>
            ...
            <div class="profile__tabs">
                <div class="profile__tabs-ctrl">
                    <div class="tab-ctrl" data-tab-ctrl="1">Личные данные</div>
                    ...
                    <div class="tab-ctrl active" data-tab-ctrl="6">Договор</div>
                </div>
                <div class="profile__tabs-body">

                    <!-- Личные данные -->
                    <div class="tab-body" data-tab-body="1">
                                        ...
                                        <div class="profcards__item">
                                            <div class="profcards__item-header">
                                                <div class="profcards__item-img">
                                                    <img src="./assets/img/profcards__item-1.png" alt="Даниил">
                                                </div>
                                            ...
                                            <div class="profcards__item-inputs">
                                                <label class="profgeneral__input">
                                                    ...
                                                    <input type="text" name="profname" value="Даниил">
                                                </label>
                                                <label class="profgeneral__input">
                                                    <div class="profgeneral__input-label">Дата рождения</div>
                                                    <div class="date-container">
                                                        <input type="date" name="birthdate" value="1980-03-24">
                                                    </div>
                                                </label>
                                            </div>
                                        </div>
                                ...
                                <div class="profgeneral">
                                    ...
                                    <label class="profgeneral__input">
                                        ...
                                        <div class="textarea-container">
                                            <textarea name="about">Lorem Ipsum - это текст-"рыба", часто используемый в печати и вэб-дизайне. Lorem Ipsum является стандартной "рыбой" для текстов на латинице с начала XVI века. </textarea>
                                        </div>
                                    </label>
                            ...
                            <div class="profile__second">
                                <div class="profgeneral">
                                    ...
                                    <label class="profgeneral__input">
                                        ...
                                        <input type="text" name="email" value="psycho@mail.ru">
                                        <div class="subscribe">
                                            <label class="subscribe__item">
                            ...
                            <div class="profile__second">
                                <div class="profgeneral">
                                    ...
                                    <div class="profgeneral__input">
                                        ...
                                        <div class="radio-container">
                                            <label class="radio-container__label">
                                                <input type="radio" name="clients-age" value="16+" checked="">
                                                <div class="radio-container__input">16+</div>
                                            </label>
                                            <label class="radio-container__label">
                                                <input type="radio" name="clients-age" value="18+">
                                    ...
                                    <div class="profgeneral__input">
                                        ...
                                        <div class="radio-container">
                                            <label class="radio-container__label">
                                                <input type="radio" name="identity-search" value="Да" checked="">
                                                <div class="radio-container__input">Да</div>
                                            </label>
                                            <label class="radio-container__label">
                                                <input type="radio" name="identity-search" value="Нет">
                                    ...
                                    <div class="profgeneral__input">
                                        ...
                                        <div class="radio-container">
                                            <label class="radio-container__label">
                                                <input type="radio" name="couple-work" value="Да" checked="">
                                                <div class="radio-container__input">Да</div>
                                            </label>
                                            <label class="radio-container__label">
                                                <input type="radio" name="couple-work" value="Нет">
                                                <div class="radio-container__input">Нет</div>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="education">
                                            ...
                                            <div class="education__place">
                                                ...
                                                <div class="education__input">
                                                    <input type="text" name="education-place" value="МГУ">
                                                </div>
                                            </div>
                                            <div class="education__year">
                                                <div class="education__label">Год</div>
                                                <div class="education__input">
                                                    <input type="text" name="education-year" value="2001">
                                                </div>
                                            </div>
                                        </div>
                                                                            <div class="education__item">
                    ...
                    <!-- Договор -->
                    <div class="tab-body active" data-tab-body="6">
