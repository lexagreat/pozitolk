<template>
    <div class="form-container">
        ...
        <div class="form-group">
            ...
            <input v-model="form.phone" type="tel" @input="formatPhoneNumber" placeholder="+7XXXXXXXXXX" maxlength="12">
        </div>
        <div class="form-group">
            <label>Возраст:</label>
...
const isPhoneValid = ref(true); // Для отображения ошибки валидации
...
const formatPhoneNumber = (event) => {
    ...
    if (!phone.startsWith('7')) {
        phone = '7' + phone; // Добавляем 7, если отсутствует
    }
    ...
    isPhoneValid.value = /^\+7\d{10}$/.test(phone);
};
const addEducation = () => {
